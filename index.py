...
hypertension_indx = 1 if hypertension == "Yes" else 0
heart_disease_indx = 1 if heart_disease == "Yes" else 0

data = {
    "age": [age],
    "hypertension": [hypertension_indx],
    "heart_disease": [heart_disease_indx],
